    ...
    <div className="bg-background min-h-screen">
      <div className="2xl:max-w-[1400px] max-w-[1000px] mx-auto py-6 px-4">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-text-primary">{experience.price_range}</span>
        </div>
        ...
        {place.instagram_handle && (
          <a
            ...
            className="flex items-center gap-3 mb-4 text-text-primary hover:text-primary transition-colors"
          >
        ...
        {experience.phone_number && (
          <a
            ...
            className="flex items-center gap-3 mb-6 text-text-primary hover:text-primary transition-colors"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
