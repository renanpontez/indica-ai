      ...
      <div className="max-w-4xl mx-auto px-4 py-6 md:px-6 lg:px-8">
        ...
        {place.instagram_handle && (
          <a
            ...
            className="flex items-center gap-3 mb-4 text-text-primary hover:text-accent transition-colors"
          >
        ...
        {experience.phone_number && (
          <a
            ...
            className="flex items-center gap-3 mb-6 text-text-primary hover:text-accent transition-colors"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
